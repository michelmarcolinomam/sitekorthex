  ...
  head: () => ({
    meta: [
      { title: "Korthex Executivo — Arquitetura de Evolução do Fundador" },
      {
        name: "description",
        content:
          "Korthex Executivo: desenvolvimento estratégico para fundadores, sócios, CEOs e executivos. O processo não parte da empresa — parte da pessoa que a conduz.",
      },
      {
        property: "og:title",
    ...
    <main className="bg-background text-foreground antialiased selection:bg-primary selection:text-primary-foreground min-h-screen">
      ...
      <section className="relative overflow-hidden px-6 md:px-12 pt-40 pb-20 md:pt-56 md:pb-28">
        ...
        <div className="relative mx-auto max-w-[1100px]">
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.3em] text-foreground/55">
            ...
            <span>Korthex Executivo · Individual</span>
          </div>
          <h1
          ...
          <p className="mt-10 max-w-[60ch] text-foreground/75 text-lg md:text-xl leading-relaxed">
            Desenvolvimento estratégico para fundadores, sócios, CEOs e
            executivos que compreenderam que o crescimento da organização está
            diretamente ligado à própria capacidade de evolução.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 md:px-12 pb-20 md:pb-28">
        <div className="mx-auto max-w-[1100px]">
          ...
          <p className="mt-4 text-[11px] uppercase tracking-[0.25em] text-foreground/40">
            Korthex Executivo · Michel Marcolino
          </p>
        </div>
      </section>
      ...
      <section className="px-6 md:px-12 py-20 md:py-28 bg-[color:var(--surface)]">
        <div className="mx-auto max-w-[820px]">
          ...
          >
            O Korthex Executivo não parte da empresa.{" "}
            <span className="italic text-primary">
              Parte da pessoa que a conduz.
            </span>
          </p>
          <div className="space-y-8 text-foreground/85 text-lg md:text-xl leading-relaxed">
            <p>
              Toda empresa carrega, em alguma medida, os limites emocionais,
              comportamentais e estratégicos de quem a lidera. Por isso o
              trabalho não começa pela operação, pela meta ou pelo organograma —
              começa pela identidade de quem decide.
            </p>
            <p>
              Mais do que desenvolver competências de gestão, o programa amplia
              consciência. É um trabalho sério, técnico e, por vezes,
              desconfortável — desenhado para sustentar o próximo ciclo de
              crescimento sem que o executivo se torne o seu próprio teto.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* O que é trabalhado */}
      <section id="trabalho" className="relative px-6 md:px-12 py-24 md:py-32">
        <div className="mx-auto max-w-[1100px]">
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.3em] text-foreground/55">
          ...
          >
            Não competências isoladas. Uma{" "}
            <span className="italic text-primary">arquitetura interna.</span>
          </h2>
          <p className="max-w-[60ch] text-foreground/70 text-base md:text-lg leading-relaxed mb-16">
            O processo constrói clareza sobre quem o executivo é hoje, quais
            impactos essa identidade produz na organização e quais capacidades
            precisam ser desenvolvidas. Cada eixo abaixo é trabalhado em
            profundidade, não em superfície.
          </p>
          ...
          <div className="space-y-px">
            {[
              {
                n: "01",
                t: "Consciência & Autopercepção",
                q: "O que este executivo projeta na organização sem perceber?",
                d: "Antes de impactar a organização, todo comportamento impacta quem o produz. Este eixo investiga padrões emocionais, crenças, mecanismos de proteção e experiências que influenciam silenciosamente a forma como o executivo lidera, decide, se relaciona e conduz o negócio.",
              },
              {
                n: "02",
                t: "Identidade & Posicionamento",
                q: "Quem é o executivo quando ninguém está olhando — e o que essa identidade produz dentro da organização?",
                d: "Toda organização absorve, em alguma medida, a identidade de quem a conduz. Este eixo trabalha a consciência sobre padrões, crenças, comportamentos e posicionamentos que impactam silenciosamente a cultura, as decisões e os resultados da empresa.",
              },
              {
                n: "03",
                t: "Decisão & Gestão Emocional",
                q: "A decisão nasce de convicção estratégica ou da tentativa de aliviar um desconforto momentâneo?",
                d: "Toda decisão carrega uma carga emocional. Este eixo desenvolve a capacidade de sustentar clareza, critério e responsabilidade mesmo em contextos de pressão, incerteza e conflito.",
              },
              {
                n: "04",
                t: "Liderança & Sucessão",
                q: "A organização consegue evoluir sem depender permanentemente da presença do fundador?",
                d: "O crescimento sustentável exige que a capacidade de decidir e liderar deixe de estar concentrada em uma única pessoa. Este eixo trabalha a formação de lideranças, a construção de autonomia e a transferência gradual de autoridade.",
              },
              {
                n: "05",
                t: "Visão de Futuro & Cultura",
                q: "Que organização está sendo construída pelas escolhas que são feitas hoje?",
                d: "Toda cultura é construída pelas decisões que se repetem ao longo do tempo. Este eixo amplia a consciência sobre o papel do executivo na formação dos comportamentos, das prioridades e da direção que sustentará os próximos ciclos de crescimento.",
              },
            ].map((e) => (
              <article
                key={e.n}
      ...
      {/* Para quem é / não é (surface) */}
      <section className="px-6 md:px-12 py-20 md:py-28 bg-[color:var(--surface)]">
        <div className="mx-auto max-w-[1100px]">
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.3em] text-foreground/55">
            <span className="text-primary">02</span>
            <span className="w-8 hairline" />
            <span>Filtro de admissão</span>
          </div>
          <h2
            className="text-display text-foreground mt-10 mb-16"
            style={{ fontSize: "clamp(1.75rem, 3.5vw, 3rem)", lineHeight: 1.05 }}
          >
            Um programa que começa por dizer{" "}
            <span className="italic text-primary">para quem não é.</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
            ...
            <div className="md:col-span-6">
              ...
              <ul className="space-y-px">
                {[
                  ...
                  "CEOs",
                  "Sucessores",
                  "Diretores do último nível executivo",
                ].map((item, i) => (
                  <li
                    key={item}
                    className="group flex items-baseline gap-6 border-t border-border py-5"
                  >
                    <span className="text-display text-xl text-primary/40 group-hover:text-primary transition-colors leading-none tabular-nums">
            ...
            <div className="md:col-span-5 md:col-start-8">
              <p className="text-[10px] uppercase tracking-[0.3em] text-foreground/45 mb-8">
                Para quem não é
              </p>
              <ul className="space-y-5">
                {[
                  ...
                  "Profissionais sem responsabilidade estratégica sobre a organização",
                ].map((item) => (
                  <li
                    key={item}
                    className="flex items-baseline gap-4 text-foreground/45"
                  >
                    <span className="text-foreground/30 text-sm shrink-0">
                      ×
                    </span>
      ...
      <section className="relative px-6 md:px-12 py-24 md:py-32">
        <div className="mx-auto max-w-[1100px]">
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.3em] text-foreground/55">
            ...
            <span className="w-8 hairline" />
            <span>Transformação esperada</span>
          </div>
          <div className="mt-12 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-start">
            <div className="md:col-span-7">
              ...
              >
                O próximo ciclo da empresa exige uma{" "}
                <span className="italic text-primary">
                  nova versão do fundador.
                </span>
              </h2>
            </div>
            <div className="md:col-span-4 md:col-start-9">
              <p className="text-foreground/75 text-base md:text-lg leading-relaxed">
                Mais consciente sobre seus impactos, mais madura diante da
                pressão e mais preparada para desenvolver pessoas, formar
                sucessores e sustentar crescimento.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
            <div className="md:col-span-5">
              <p className="text-foreground/75 text-base leading-relaxed">
                O Korthex Executivo começa por uma conversa privada de
                diagnóstico. Sem proposta pronta, sem script. Apenas escuta — e
                a leitura honesta de se faz sentido continuar.
              </p>
              <a
